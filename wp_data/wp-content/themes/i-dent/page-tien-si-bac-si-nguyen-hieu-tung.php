...
?>
      <div class="mv">
        <img class="is-pc"   src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/bnr.jpg.webp" alt="">
      ...
      <section class="about-bstung">
        <div class="wrapper">
          ...
          <div class="loibacsi">
            <div class="img is-sp"><img loading="lazy"  src="/wp-content/uploads/2023/07/bstung.webp" alt=""></div>
            <quote>
      ...
      <section class="hocvan">
        <div class="wrapper">
          ...
          <div class="gr-images">
            <div class="big-img"><img class="is-pc" loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_01.jpg.webp" alt=""><img class="is-sp" loading="lazy"  src="/wp-content/uploads/2023/07/Ts-Bs-Nguyen-Hieu-Tung-du-hoc-phap-chuyen-nganh-cay-ghep-implant.webp" alt=""></div>
            <div class="small-img is-pc">
              <div class="img"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_02.jpg.webp" alt=""></div>
              <div class="img"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_03.jpg.webp" alt=""></div>
            </div>
          </div>
          <div class="l-doctors">
            <div class="l-doctors_item">
              <div class="l-doctors_images is-pc"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_doc_04.png.webp" alt="TIẾN SĨ - BÁC SĨ NGUYỄN HIẾU TÙNG"></div>
          ...
          <div class="video"><a class="vidplay" href="https://www.youtube.com/watch?v=WXX4qCbyts0">
        ...
        <div class="wrapper">
          ...
          <ul class="l-demo">
            ...
            <li class="l-demo_item">
              <div class="wrap">
                <div class="demo-img">
                  <div class="img-big"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_big_02.jpg.webp" alt=""></div>
                  <div class="img-small">
                    <div class="img before"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_small_03.jpg.webp" alt=""></div>
                    <div class="img after"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_small_04.jpg.webp" alt=""></div>
                  </div>
                </div>
                <div class="demo-info">
                  <div class="demo-info_name">
            ...
            <li class="l-demo_item">
              <div class="wrap">
                <div class="demo-img">
                  <div class="img-big"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_big_03.jpg.webp" alt=""></div>
                  <div class="img-small">
                    <div class="img before"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_small_05.jpg.webp" alt=""></div>
                    <div class="img after"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_small_06.jpg.webp" alt=""></div>
                  </div>
                </div>
                <div class="demo-info">
                  <div class="demo-info_name">
      ...
      <section class="customer-review">
        <div class="wrapper">
          ...
          <div class="m-review">
            <div class="m-review_img is-pc"><img loading="lazy"  src="/wp-content/uploads/2023/07/khach-hang-cay-ghep-implant.webp" alt=""></div>
            <div class="m-review_info">
              <div class="head">
                <div class="img is-sp"><img loading="lazy"  src="/wp-content/uploads/2023/07/khach-hang-cay-ghep-implant.webp" alt=""></div>
          ...
          <div class="m-review is-reverse">
            <div class="m-review_img is-pc"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_cus.jpg.webp" alt=""></div>
            <div class="m-review_info">
              <div class="head">
          ...
          <div class="hinhdanh">
            <div class="wrap">
              <div class="img"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_04.png.webp" alt=""></div>
              <div class="img"><img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/img_05.png.webp" alt=""></div>
          ...
          <div class="l-paper js-paper-slide">
            <div class="m-paper_item">
              <div class="m-paper_inner">
                <div class="m-paper_wrap"><img   src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/bs-ts-nguyen-hieu-tung-cafef.png" alt="">
            ...
            <div class="m-paper_item">
              <div class="m-paper_inner">
                <div class="m-paper_wrap"><img   src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/bs-ts-nguyen-hieu-tung-thanh-nien.png" alt="">
                  <div class="m-paper_btn">
            ...
            <div class="m-paper_item">
              <div class="m-paper_inner">
                <div class="m-paper_wrap"><img   src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/bs-tung/danh-gia-dich-implant-nha-khoa-i-dent.png" alt="">
                  <div class="m-paper_btn">
