...
?>
      ...
      <div class="m-phacdo m-loairang">
        <div class="wrapper">
          <div class="m-phacdo_inner">
            ...
            <p class="text intro-text">Về nước trồng răng hay bọc răng sứ thẩm mỹ hiện đang là lựa chọn phổ biến của nhiều Việt kiều. Tuy nhiên, do khoảng cách địa lý xa xôi và thời gian hạn hẹp khiến cho các khách hàng Việt kiều gặp không ít khó khăn khi về nước làm răng.</p>
          </div>
      ...
      <div class="wrapper">
        <div class="box-information is-short">
          ...
          <form class="form-reserve is-pc" action="">
      ...
      <section class="m-contact is-reverse is-sp">
