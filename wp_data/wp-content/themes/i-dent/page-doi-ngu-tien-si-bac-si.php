...
?>
  <div class="mv">
    <img loading="lazy" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/reason/bnr.jpg" alt="">
  </div>
  <div class="wrapper">
    <div class="doc-intro">
    ...
    <ul class="l-doctors">
      ...
      <li class="l-doctors_item">
        <div class="l-doctors_images">
          <img  loading="lazy" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/doctor/img_doc_10.png" alt="BÁC SĨ LÊ ĐẶNG VINH">
        </div>
        <div class="l-doctors_info">
          <div class="l-doctors_info_inner">
