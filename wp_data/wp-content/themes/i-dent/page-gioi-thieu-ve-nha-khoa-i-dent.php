      ...
      <div class="page-bnr">
        <div class="wrapper">
          <div class="page-bnr_inner">
            <div class="left">
              <h2 class="ttl-primary is-red">NHA KHOA I-DENT</h2><strong><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/ttl.svg" alt="Ươm mầm răng mới"></strong>
            ...
            <div class="right"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/img_doc.png" alt=""></div>
          </div>
        </div>
      </div>
      <div class="m-about">
        <div class="wrapper">
          ...
          <div class="m-about_block">
            ...
            <ul class="l-slogan">
              <li class="l-slogan_item">
                <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/ico_zoom.svg" alt="" style="left: 9px;position: relative;top: 7px;"></div>
              ...
              <li class="l-slogan_item">
                <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/ico_shield.svg" alt=""></div>
              ...
              <li class="l-slogan_item">
                <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/ico_judge.svg" alt=""></div>
              ...
              <li class="l-slogan_item">
                <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/ico_hand.svg" alt=""></div>
          ...
          <div class="m-about_block m-about_block--is-col">
            ...
            <div class="right"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/about/vector_01.svg" alt=""></div>
          </div>
          <div class="m-about_block">
            ...
            <p class="text">Việc thiếu đi các thông tin kiến thức được phổ biến rộng rãi là nguyên nhân chính tạo nên sự thờ ơ và không quan tâm đúng mức đến sức khỏe răng miệng của phần lớn người dân trong nước, dẫn đấu những hậu quả nghiêm trọng về sức khỏe lâu dài, trong đó có chính gia đình của Bác sĩ Tùng.</p>
            ...
            <p class="text">Với những trăn trở và mong muốn đó của Bác sĩ Tùng đã trở thành kim chỉ nam để thành lập và phát triển Nha khoa I-DENT. Thành lập năm 2014, sau hơn 6 năm đi vào hoạt động, với sự nỗ lực không ngừng của Tiến sĩ – Bác sĩ Nguyễn Hiếu Tùng cùng với đội ngũ cộng sự Bác sĩ, phụ tá, nhân viên tại nha khoa I-DENT đã thực hiện thành công hơn 10,000 ca Implant, qua đó kiến tạo nụ cười hạnh phúc cho hàng ngàn bệnh nhân.</p>
