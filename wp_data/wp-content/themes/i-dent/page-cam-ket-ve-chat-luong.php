          ...
          <div class="m-detail_inner">
            <article class="m-detail_detail">
              ...
              <div class="m-detail_head">
                <div class="m-detail_head-right">
                  <span class="time">08.08.2022</span>
                  <div class="fl">
                    <ul class="rating">
                      <li>
                        <img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/ico_star.svg" alt="">
                      </li>
                      <li>
                        <img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/ico_star.svg" alt="">
                      </li>
