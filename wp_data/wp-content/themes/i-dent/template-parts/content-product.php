...
?>
      <section id="detail_mainv">
        ...
        <ul class="breadcrumb">
          <li>
            <a href="<?php echo home_url(); ?>"><?php _e('Home', 'i-dent'); ?></a>
          </li>
          <li>
          ...
          <div class="m-blockdetail">
            ...
            <div class="m-blockdetail__cont">
              <div class="block-top">
                <h4><?php the_title(); ?></h4>
                <ul class="list-tag">
                  <li><?php _e('Product SKU : ', 'i-dent'); ?><span class="bold"><?php echo $sku ?></span>
                  </li>
                  <li>Dekton - Onirika</li>
                </ul>
                <div class="m-blockdetail__tab">
                  <ul class="tab-ttl">
                    <li class="active"><?php _e('Description', 'i-dent'); ?></li>
                    <li><?php _e('Specifications', 'i-dent'); ?></li>
                  </ul>
                  <div class="tab-cont">
      ...
      <section id="detail_box03">
        ...
        <div class="inner">
          <h3 class="c-title02"><?php _e('Related Products', 'i-dent'); ?></h3>
