  ...
  <div class="breadcrumbs">
    <div class="wrapper">
      <ul class="l-breadcrumbs">
        ...
        <li><a class="trans" href="#">Câu chuyện khách hàng</a></li>
    ...
    <div class="m-detail">
      <div class="m-detail_video is-sp">
        <a class="vidplay" href="https://www.youtube.com/watch?v=WXX4qCbyts0">
          <img src="
					<?php echo get_stylesheet_directory_uri() ?>/assets/images/top/img_tv_01.jpg">
        </a>
      </div>
      <div class="m-detail_head">
        <span class="tag">CÂU CHUYỆN KHÁCH HÀNG</span>
        <h2 class="post-title ttl-primary">CÔ MỸ NHI TẤT ( VIỆT KIỀU ÚC)</h2>
      ...
      <div class="box-short">
        ...
        <ul class="l-short">
          <li>
            <span>Tình trạng răng:</span>Mất toàn bộ răng hàm trên
          </li>
          <li>
            <span>Hướng điều trị:</span>Cấy ghép Implant All On 5 hàm trên
          </li>
          <li>
            <span>Trụ Implant và Răng sứ sử dụng:</span>Implant Mis C1 Đức và phục hình răng sứ Zirconia DDBio Đức
          </li>
        </ul>
      </div>
      <div class="ekip">
        ...
        <ul class="l-ekip">
          <li class="l-ekip_item">
            <div class="img">
              <img src="
									<?php echo get_stylesheet_directory_uri() ?>/assets/images/story/img_doc_01.png" alt="">
            </div>
            <div class="info">
              <span class="pos">Bác sĩ cấy Implant</span>
              <span class="ttl">Tiến sĩ - Bác sĩ</span>
              <span class="name">Nguyễn Hiếu Tùng</span>
              <div class="gr-btn">
          ...
          <li class="l-ekip_item">
            <div class="img">
              <img src="
										<?php echo get_stylesheet_directory_uri() ?>/assets/images/story/img_doc_02.png" alt="">
            </div>
            <div class="info">
              <span class="pos">Bác sĩ phục hình sứ</span>
              <span class="ttl">Bác sĩ CK1</span>
              <span class="name">Nguyễn Huỳnh Ngọc Mỹ</span>
              <div class="gr-btn">
                <div class="m-btn is-small">
                  <a href="#">Đặt lịch hẹn</a>
                </div>
          ...
          <li class="l-ekip_item support">
            <div class="img">
              <img src="
											<?php echo get_stylesheet_directory_uri() ?>/assets/images/story/img_assis_01.png" alt="">
            </div>
            <div class="info">
              <span class="pos">Phụ tá chính</span>
              <span class="name">Phạm Thị Ngọc Thanh</span>
            </div>
          </li>
          <li class="l-ekip_item support">
            <div class="img">
              <img src="
												<?php echo get_stylesheet_directory_uri() ?>/assets/images/story/img_assis_02.png" alt="">
            </div>
            <div class="info">
              <span class="pos">Tư vấn và CSKH</span>
              <span class="name">Phạm Thị Ngọc Trang</span>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="m-article">
        <p>Là một người khá kỹ tính trong việc chọn lựa nha khoa, cô Mỹ Nhi Tất quyết định chỉ làm thử hàm trên để cải thiện phần nào sức khỏe ăn nhai. Nhưng kết quả ngoài mong đợi, cô quyết định vài tháng sau cô sẽ quay trở lại I-DENT để trồng Implant cho hàm dưới. <br>Hàm răng là bộ phận rất quan trọng, giúp cho việc cắn xé thức ăn dễ dàng hơn. Tuy nhiên với người cao tuổi, chức năng ăn nhai sẽ giảm sút khi răng gặp các tình trạng như: Lung lay, sâu răng, viêm nha chu,... cô Mỹ Nhi Tất cũng không ngoại lệ. Đã từng rất đau khổ vì không thể nhai thức ăn, cô chỉ cố gắng nuốt và ăn những bữa cơm vô vị qua ngày. <br>Cô đã từng có suy nghĩ sẽ trồng răng Implant tại Úc, nhưng chưa thật sự an tâm về kế hoạch mà các bác sĩ ở đây tư vấn. Ngoài ra, hầu hết những người bạn của cô đều về Việt Nam làm răng. Đây là động lực để cô quay trở về nước trồng răng. <br>Lần đầu tiên đặt chân đến sảnh nha khoa I-DENT, cô chia sẻ rất ấn tượng về cơ sở vật chất tại đây. Bởi cô không ngờ rằng quê hương mình đã phát triển đến như vậy, có thể là hơn cả bên Úc. Cùng với những lời tư vấn nhiệt thành và sự tận tâm từ bác sĩ đã giúp cô đưa ra quyết định trồng răng Implant ngay trong hôm đó. </p>
      ...
      <div class="box-information">
        ...
        <ul class="l-social">
          ...
          <li>
            <a class="trans" href="">
              <img src="
																			<?php echo get_stylesheet_directory_uri() ?>/assets/images/ico_zalo.svg" alt="">
            </a>
          </li>
          <li>
            <a class="trans" href="">
              <img src="
																				<?php echo get_stylesheet_directory_uri() ?>/assets/images/ico_tiktok.svg" alt="">
            </a>
          </li>
        </ul>
        <ul class="l-address">
          ...
          <li>
            <span>Cơ sở 1:</span>193A-195 Hùng Vương, P.9, Quận 5, TP.Hồ Chí Minh
          </li>
          <li>
        ...
        <form class="form-reserve" action="">
          ...
          <div class="form-inner">
            ...
            <div class="gr-check">
              <span class="ttl">Vấn đề quan tâm</span>
              <ul class="l-checkbox">
                <li>
                  <div class="m-checkbox">
                    <label class="label">
                      <input type="checkbox" name="prob" value="Trồng răng Implant">
                ...
                <li>
                  <div class="m-checkbox">
                    <label class="label">
                      <input type="checkbox" name="prob" value="Niềng răng thẩm mỹ">
                      <span>Niềng răng thẩm mỹ</span>
                    </label>
                  </div>
                </li>
                <li>
                  <div class="m-checkbox">
                    <label class="label">
                      <input type="checkbox" name="prob" value="Bọc răng sứ thẩm mỹ">
                      <span>Bọc răng sứ thẩm mỹ</span>
                    </label>
                  </div>
                </li>
                <li>
                  <div class="m-checkbox">
                    <label class="label">
                      <input type="checkbox" name="prob" value="Điều trị bệnh lý nha khoa">
                      <span>Điều trị bệnh lý nha khoa</span>
                    </label>
                  </div>
                </li>
              </ul>
