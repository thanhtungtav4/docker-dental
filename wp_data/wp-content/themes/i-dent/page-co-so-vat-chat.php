 ...
 */
  get_header();
?>
      <div class="mv"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/bnr.jpg" alt="">
        <div class="mv_wrap">
          <div class="wrapper">
            <div class="mv_inner"><span class="ttx"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/txt01.svg" alt="CƠ SỞ VẬT CHẤT"></span><strong><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/txt02.svg" alt="HIỆN ĐẠI"></strong>
              <h2 class="ttl"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/bnr_title.svg" alt="TRANG THIẾT BỊ NHẬP KHẨU TỪ CHÂU ÂU 100%"></h2>
              <div class="m-btn"><a href="#">ĐẶT LỊCH HẸN</a></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="m-basis">
          <div class="m-basis_block">
            ...
            <div class="block_inner">
              ...
              <p class="text">Tại Nha khoa I-DENT được trang bị hệ thống máy chụp phim hiện đại nhất hiện nay – Máy CT Cone beam 3D. Đây là hệ thống X-quang cho hình ảnh không gian 3 chiều, giúp bác sĩ biết được chính xác bề rộng và bề sâu của xương.<br><br>Phim X-quang được chụp bằng hệ thống Cone beam còn cho thấy rõ sự tương quan giữa răng hàm dưới với dây thần kinh, sự tương quan giữa răng hàm trên với xoang hàm, kiểm tra được các sang thương sâu bên trong.<br><br>Đặc biệt khi tiến hành cấy ghép Implant, với việc sử dụng máy CT Cone beam, bác sĩ tại I-DENT sẽ đánh giá chính xác về mức độ tiêu xương cũng như độ xốp của xương để đưa ra phương án điều trị thích hợp và lựa chọn kích thước Implant phù hợp.</p>
              <div class="gr-img gr01">
                <div class="big-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_01.jpg" alt=""></div>
                <div class="side-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_02.jpg" alt=""></div>
                <div class="small-img">
                  <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_03.jpg" alt=""></div>
                  <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_04.jpg" alt=""></div>
                </div>
              </div>
            </div>
            <div class="block_inner">
              ...
              <div class="gr-img gr02">
                <div class="big-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_05.jpg" alt=""></div>
                <div class="big-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_06.jpg" alt=""></div>
              </div>
            </div>
          </div>
          <div class="m-basis_block">
            ...
            <div class="block_inner">
              ...
              <div class="gr-img gr02">
                <div class="big-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_07.jpg" alt=""></div>
                <div class="big-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_08.jpg" alt=""></div>
              </div>
              ...
              <div class="gr-img gr03">
                <div class="big-img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_09.jpg" alt=""></div>
                <div class="big-img small"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_10.jpg" alt=""></div>
              </div>
              ...
              <div class="image"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_11.jpg" alt=""></div>
              <div class="image"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_12.png" alt=""></div>
            </div>
          </div>
          <div class="m-basis_block">
            <h2 class="ttl-secondary">3.PHÒNG LABO HIỆN ĐẠI NGAY TẠI NHA KHOA</h2>
            <div class="block_inner">
              <p class="text">I-DENT là một trong số ít nha khoa tại TP HCM có thế mạnh sở hữu phòng LABO riêng, được trang bị hệ thống máy móc hiện đại.<br>Đội ngũ chuyên viên kỹ thuật lành nghề, giàu kinh nghiệm và luôn tận tâm trong công việc, nhằm mang đến những sản phẩm răng đẹp nhất cho khách hàng.<br><br>Phòng LABO Nha khoa I-DENT sử dụng các trang bị các thiết bị máy móc tối tân cùng các vật liệu nha khoa nhập khẩu chính hãng từ các quốc gia Đức, Úc, Pháp…<br><br>Gồm: Lò nung sườn Dekema (Germany), Lò nướng sứ Ivoclar P310 (Austria), Máy đúc cao tầng Bego (Germany), Phần mềm thiết kế Dental system (3Shape-Denmark), Máy Scan 3Shape E2 (Denmark), Máy Milling CORITEC 350i Pro (Germany)… Cho ra đời được những sản phẩm chính xác, các loại răng chất lượng, đạt chuẩn và phù hợp với từng khách hàng.<br><br>Những sản phẩm của phòng LABO nha khoa được đưa vào sử dụng trong các quá trình điều trị như: phục hình răng sứ trên Implant, răng sứ thẩm mỹ, hàm tháo lắp… đảm bảo độ bền cao, rút ngắn thời gian và tiết kiệm chi phí cho khách hàng.</p>
              <div class="image"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/basis/img_12.jpg" alt=""></div>
            </div>
          </div>
        </div>
      </div>
