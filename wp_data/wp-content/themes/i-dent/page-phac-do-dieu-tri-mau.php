      ...
      <section class="m-steps">
        ...
        <div class="box-information">
          ...
          <ul class="l-social">
            ...
            <li>
              <a class="trans" href="">
                <img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/ico_zalo.svg" alt="">
              </a>
            </li>
            <li>
              <a class="trans" href="">
                <img loading="lazy"  src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/ico_tiktok.svg" alt="">
              </a>
            </li>
          </ul>
          <ul class="l-address">
