      ...
      <div class="breadcrumbs">
        <div class="wrapper">
          <ul class="l-breadcrumbs">
            ...
            <li><span>Phác đồ điều trị mẫu</span></li>
          </ul>
        </div>
      </div>
      <div class="m-phacdo">
        <div class="wrapper">
          <div class="m-phacdo_inner">
            <div class="heading">
              <h2 class="ttl-primary ttl-primary--is-medium">PHÁC ĐỒ ĐIỀU TRỊ MẪU TẠI NHA KHOA I-DENT</h2><span class="time">24.04.2023</span>
            </div>
            <div class="doc-intro">
          ...
          <section class="m-steps">
            ...
            <ul class="l-steps">
              ...
              <li class="l-steps_block">
                ...
                <figure class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/dieutri/img_01.png" alt=""></figure>
              </li>
              <li class="l-steps_block">
                <h3 class="title">Bước 3:  Sơ đồ điều trị</h3>
                ...
                <figure class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/dieutri/img_02.png" alt=""></figure>
              </li>
              <li class="l-steps_block">
                <h3 class="title">Bước 4:  Tính toán chi phí trọn gói</h3>
                ...
                <figure class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/dieutri/img_03.png" alt=""></figure>
              </li>
              <li class="l-steps_block">
                <h3 class="title">Bước 5:  Xác định thời gian điều trị và phương án thanh toán</h3>
                <p class="text">Thời gian có thể phục hình sứ được đưa ra rõ ràng và chi tiết. Kèm theo là phương án thanh toán.</p>
                <figure class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/dieutri/img_05.png" alt=""></figure>
              </li>
            </ul>
            ...
            <div class="warning"><span class="ttl">Lưu ý</span>
              <p class="text">Cô chú anh chị sẽ nhận được phiếu kế hoạch điều trị đầy đủ như hình bên dưới và không bắt buộc điều trị tại Nha Khoa I-Dent<br>Hãy sữ dụng như tài liệu tham khảo để loại bỏ những nha khoa kém chất lượng và so sánh giữa nhiều nha khoa khác nhau để có sự lựa chọn phù hợp.<br><br><span>Phác đồ điều trị online chỉ dùng tham khảo với độ chính xác > 80%. Để tiến hành điều trị cần được thăm khám trực tiếp, chụp film 3D, xét nghiệm. Nhằm đảm bảo độ chính xác tuyệt đối.</span></p>
              <div class="img"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/dieutri/img_04.png" alt=""></div>
            </div>
