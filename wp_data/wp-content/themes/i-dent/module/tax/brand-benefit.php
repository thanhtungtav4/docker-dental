...
<section id="dekton_box03">
  <div class="inner">
    <h3 class="c-title02 c-title02--01"><?php _e('Benefits of', 'i-dent') ?> <?php single_term_title(); ?></h3>
    <div class="benefit__block">
      <?php
      $queryArgsWorks = new WP_Query($argsArgsWorks);
      if( $queryArgsWorks->have_posts() ): ?>
        <dl>
          <dt class="active"><?php _e('ADVANTAGE', 'i-dent') ?></dt>
          <dd>
      ...
      <?php if(get_field('tax_design_options', $taxonomy_term)) : ?>
        <dl>
          <dt class=""><?php _e('Design options', 'i-dent') ?></dt>
      ...
      <dl>
        <dt class=""><?php _e('Improve', 'i-dent') ?></dt>
        <dd style="display: none;">
